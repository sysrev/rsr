...
Extracted tables can be joined on the article identifier (aid).

Here, joined basic/biomarker tables can link trials and biomarkers. `ggplot2::geom_tile` can then quickly visualize these relationships.
...
Now you know how to get open access review data on sysrev.
