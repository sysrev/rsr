...
To create the FDA source go to [sysrev.com/p/111474/add-articles](https://sysrev.com/p/111474/add-articles). We'll select new drug application **`NDA`** documents of document type **`label`** that match **"cardiotoxicity"**. Learn more about FDA applications types at [FDA How Drugs Are Developed.](https://www.fda.gov/drugs/how-drugs-are-developed-and-approved/types-applications)
